...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    <div class="w3-container" style="padding: 10px;">
		<lable>Tile</lable><br>
		<input data-ng-model="board.title"><br>
		<lable>Content</lable><br>
		<input data-ng-model="board.content"><br><br>
		<button type="button" data-ng-click="setNotice()">Submit</button>
